...
# Function/tool to record user details
def record_user_details(email, name="Name not provided", notes="not provided"):
    push(f"Recording {name} with email {email} and notes {notes}")
    return {"recorded": "ok"}

# Function/tool to record unknown questions
def record_unknown_question(question):
    push(f"Recording {question}")
    return {"recorded": "ok"}

# JSON object to record user details
...
# JSON object to record unknown questions
...
# Class to represent the evaluation
...
class Me:
    ...
    # Function to give the system a prompt
...
If the user is engaging in discussion, try to steer them towards getting in touch via email; ask for their email and record it using your record_user_details tool. "
    ...
    # Function to evaluate whether the response from the system is acceptable
    ...
    # Function to evaluate whether the response from the user is acceptable
    ...
    # Function to perform the evalutaions
    ...
    # Function to rerun the evaluation process if the response fails the evulation
    ...
    def chat(self, message, history):
        ...
        evaluation = self.evaluate(agent_response, message, history)
        ...
        if evaluation.is_acceptable:
            ...
            agent_response = self.rerun(agent_response, message, history, evaluation.feedback)
